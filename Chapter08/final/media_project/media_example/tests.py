...
class Exercise7Test(LiveServerTestCase):
    ...
    def test_form_in_template(self):
        ...
        self.assertIn(
            b'<input type="file" name="image_field" accept="image/*" required id="id_image_field">',
            resp.content,
        )
        self.assertIn(
            b'<input type="file" name="file_field" required id="id_file_field">',
            resp.content,
        )
        ...
        try:
            ...
            with open(
                ...
                with open(
                    ...
                    resp = c.post(
                        "/media-example/",
                        {"file_field": css_fp, "image_field": logo_fp},
                    )
